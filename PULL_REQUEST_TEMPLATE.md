Please check if what you want to add to `lachesis-base` list meets [quality standards](https://github.com/deamchain/deam-base/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
